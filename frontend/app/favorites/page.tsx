      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-foreground">찜한 영화</h1>
          </div>
                  ...
                  {favorites.map((movie, index) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="absolute top-2 left-2 p-2 bg-foreground/20 hover:bg-primary-600 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-200 z-10"
                        title="찜 해제"
                      >
                        {removingId === movie.id ? (
