          ...
          >
            ...
            <div className="flex space-x-3 mt-1">
              <button
                ...
                className="flex items-center space-x-2 bg-white text-foreground px-4 md:px-6 py-2.5 md:py-3 rounded-md font-medium hover:bg-white/90 transition text-sm md:text-base"
              >
