    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative w-full max-w-4xl max-h-[90vh] bg-background rounded-lg overflow-hidden overflow-y-auto shadow-2xl"
        >
          {/* Close Button */}
          <button
            onClick={onClose}
            className="absolute top-4 right-4 z-10 w-10 h-10 bg-foreground/10 hover:bg-foreground/20 rounded-full flex items-center justify-center transition"
          >
          ...
          <div className="p-6 md:p-8 -mt-20 relative">
            ...
            <div className="flex flex-wrap items-center gap-3 text-sm text-foreground/70 mb-6">
              ...
              {movie.certification && (
                <>
                  <span>|</span>
                  <span className="px-2 py-0.5 border border-foreground/30 rounded text-xs">
                    {movie.certification}
                  </span>
                </>
              )}
            ...
            {detail?.cast_members && detail.cast_members.length > 0 && (
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-foreground mb-2">출연</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8 p-4 bg-foreground/5 rounded-lg">
              {/* 찜하기 버튼 */}
              <button
              ...
              <div className="flex items-center space-x-3">
                <span className="text-foreground/70 text-sm">내 평점:</span>
            ...
            {similar.length > 0 && (
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-4">비슷한 영화</h3>
